...
const MentionsLegalesPage = () => {
  return (
    <main className="mainmention main">
      <h2>Mentions légales</h2>
      <p className="mentionLegHaut">
        ...
        du site et des services par PHILIANCE et de définir les conditions
        ...
        services proposés par le site. Cv theque Philiance se réserve le droit
        de modifier unilatéralement et à tout moment le contenu des présentes
        CGU.
      </p>
      <div className="mentionl">
        <h6> Article 1 : Les mentions légales</h6>
        <p>
          L'édition du site Cv theque Philiance est assurée par la Société
          PHILIANCE PHILIANCE au capital de _______________ euros, immatriculée
          au RCS de EVRY sous le numéro 480 842 574, dont le siège social est
          situé au 37 RUE MICHEL ANGE PARC ELYSEE 91080 EVRY Numéro de téléphone
          +33 1 69 47 45 90 Adresse e-mail : _______________. Le Directeur de la
          publication est : Emilie Tessier L'hébergeur du site Cv theque
          Philiance est la société _______________, dont le siège social est
          situé au _______________, avec le numéro de téléphone :
          _______________.
        </p>
      </div>
      <div className="mentionl">
        <h6> ARTICLE 2 : Accès au site</h6>
        <p>
          Le site Cv theque Philiance permet à l'Utilisateur un accès gratuit
          aux services suivants : Le site internet propose les services suivants
          : CV-thèque : création espace membre et entreprises. Mettre en
          relation des entreprises et des candidats. Le site est accessible
          ...
          la responsabilité de Cv theque Philiance. Dans ces cas, l’Utilisateur
      ...
      <div className="mentionl">
        <h6> ARTICLE 3 : Collecte des données</h6>
        <p>
      ...
      <div className="mentionl">
        <h6> ARTICLE 5 : Responsabilité</h6>
        <p>
          Les sources des informations diffusées sur le site Cv theque Philiance
          ...
          contractuelle. Malgré des mises à jour régulières, le site Cv theque
          Philiance ne peut être tenu responsable de la modification des
          ...
          de passe. Le site décline toute responsabilité. Le site Cv theque
          Philiance ne peut être tenu pour responsable d’éventuels virus qui
          ...
          provenant de ce site. La responsabilité du site ne peut être engagée
          en cas de force majeure ou du fait imprévisible et insurmontable d'un
          tiers.
        </p>
      </div>
      <div className="mentionl">
        <h6> ARTICLE 6 : Liens hypertextes</h6>
        <p>
          Des liens hypertextes peuvent être présents sur le site. L’Utilisateur
          est informé qu’en cliquant sur ces liens, il sortira du site Cv theque
          Philiance. Ce dernier n’a pas de contrôle sur les pages web sur
          lesquelles aboutissent ces liens et ne saurait, en aucun cas, être
          responsable de leur contenu.
        </p>
      </div>
      <div className="mentionl">
        <h6> ARTICLE 7 : Cookies</h6>
        <p>
          ...
          navigateur et qui sont nécessaires à l’utilisation du site Cv theque
          Philiance. Les cookies ne contiennent pas d’information personnelle et
          ...
          pour améliorer le site Cv theque Philiance. En naviguant sur le site,
      ...
      <div className="mentionl">
        <h6> ARTICLE 8 : Publication par l’Utilisateur</h6>
        <p>
          Le site permet aux membres de publier les contenus suivants : Publier
          son CV : parcours scolaire et professionnel , et coordonnées
          personnelles. Dans ses publications, le membre s’engage à respecter
          les règles de la Netiquette (règles de bonne conduite de l’internet)
          et les règles de droit en vigueur. Le site peut exercer une modération
          ...
          titulaire de l’intégralité de ses droits de propriété intellectuelle.
          Mais en publiant une publication sur le site, il cède à la société
          ...
          ou par un tiers autorisé, dans le monde entier, sur tout support
          ...
          internet et sur les réseaux de téléphonie mobile. La société éditrice
          s'engage à faire figurer le nom du membre à proximité de chaque
          utilisation de sa publication. Tout contenu mis en ligne par
