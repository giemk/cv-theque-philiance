            ...
            <Row>
              <Col md={4}>
                <Form.Group className="mb-3 ">
                  <Form.Control type="file" placeholder="Importer votre CV" />
                </Form.Group>
              </Col>
              <Col>
                <Form.Group className="mb-3">
        ...
        <div>
          ...
          <Form>
            <Row>
              <Col>
                <Form.Group className="mb-3 ">
                  <Form.Control type="text" placeholder="Intitulé du poste" />
                </Form.Group>
              </Col>
            </Row>
            <Row>
            ...
            <Row>
              ...
              <Fragment>
                ...
                <Col md={1}>
                  ...
                  {show3 ? <Calendar onChange={setDate} value={date} /> : null}
                </Col>
              </Fragment>
            </Row>
            <Form.Group className="mb-3">
            ...
            <Row>
              <Fragment>
                ...
                <Col md={1}>
                  ...
                  {show1 ? <Calendar onChange={setDate} value={date} /> : null}
                </Col>
              </Fragment>
              <Fragment>
                <Col md={5}>
                ...
                <Col md={1}>
                  <Button onClick={() => setShow2(!show2)} variant="outline-primary">
                    Calendrier
                  </Button>
                  {show2 ? <Calendar onChange={setDate} value={date} /> : null}
                </Col>
              </Fragment>
            </Row>
          </Form>
